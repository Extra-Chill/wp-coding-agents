...
For parallel repo work, create or reuse a Data Machine Code workspace checkout, then launch the helper session through native Kimaki cwd routing. Data Machine Code owns repo/workspace setup; Kimaki carries the Discord session.
